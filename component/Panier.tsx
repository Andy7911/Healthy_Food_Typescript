...
import { Item } from '../context/CartProvider';

type Props = {
    navigation: NavigationStackProp<{}>;
  }
export class Panier extends React.Component<Props>{
    ...
    const swipeLeft=()=>{
        ...
        <View>
            <Text style={styles.deleteBox}></Text>
             ...
             const itemsCart = panier.map((item:any) =>{
                return (
            ...
            const sum = panier.reduce(function (total:any, currentValue:any) {
